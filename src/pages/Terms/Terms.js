    ...
    return (
        <div className={s.root}>
            <div className={s.root__main}>
                ...
                <p>1.1.	Настоящее Пользовательское соглашение относится к сайту гостиничных услуг  «gesh-village », расположенному
                    по адресу адрес интернет-магазина, и ко всем соответствующим сайтам, связанным с сайтом https://geshvillage.ru/.
                    1.2.	Сайт Gesh-Village  является собственностью название организации, предприятия <br/>
                    1.3.	Настоящее Соглашение регулирует отношения между Администрацией сайта Gesh-Village -  ООО "ГЕШ ВИЛИДЖ" и Пользователем данного Сайта. <br/>
                ...
                <h4>2.	ОПРЕДЕЛЕНИЯ ТЕРМИНОВ</h4>
                <p>
                    2.1.	Перечисленные ниже термины имеют для целей настоящего Соглашения следующее значение: <br/>
                    2.1.1 Gesh-Village– сайт по продаже гостиничных услуг, расположенный на доменном имени https://geshvillage.ru/ , осуществляющий свою деятельность посредством Интернет-ресурса и сопутствующих ему сервисов. <br/>
                    ...
                    2.1.4. Пользователь сайта Интернет-магазина – лицо, имеющее доступ к Сайту, посредством сети Интернет и использующее Сайт.<br/>
                    2.1.5. Содержание сайта Интернет-магазина : личный кабинет , о проекте , каталог объектов , местоположение  - охраняемые результаты интеллектуальной деятельности, включая тексты литературных произведений, их названия, предисловия, аннотации, статьи, иллюстрации, обложки, музыкальные произведения с текстом или без текста, графические, текстовые, фотографические, производные, составные и иные произведения, пользовательские интерфейсы, визуальные интерфейсы, названия товарных знаков, логотипы, программы для ЭВМ, базы данных, а также дизайн, структура, выбор, координация, внешний вид, общий стиль и расположение данного Содержания, входящего в состав Сайта и другие объекты интеллектуальной собственности все вместе и/или по отдельности, содержащиеся на сайте Интернет-магазина.
                </p>
                ...
                <p>
                    ...
                    •	доступ к электронному контенту на  платной основе, с правом приобретения (скачивания), просмотра контента;<br/>
                    ...
                    3.2. Настоящее Соглашение является публичной офертой. Получая доступ к Сайту Пользователь считается присоединившимся к настоящему Соглашению.<br/>
                ...
                <p>
                    <b>4.1. Администрация сайта вправе:</b>
                ...
                <p>
                    <b>4.2. Пользователь вправе:</b><br/>
                ...
                <p>
                    <b>4.3. Пользователь Сайта обязуется:</b><br/>
                ...
                <p>
                    <b>4.4. Пользователю запрещается:</b><br/>
                ...
                <h4>5.	ИСПОЛЬЗОВАНИЕ САЙТА ИНТЕРНЕТ-МАГАЗИНА</h4>
                <p>
